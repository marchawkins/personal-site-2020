...
<main class="flex-grow bg-black text-gray-600 body-font"  id="guestbook">
 <div class="container  mx-auto" id="guestCapture">
  ...
  <div class="flex flex-wrap -mx-4 -mb-10 text-center">
    <div class="sm:w-1/2 mb-10 px-4 max-w-sm mx-auto">
      <div class="rounded-lg h-64 my-4 border-2 border-terminal overflow-hidden">
          <video class="videostream" autoplay ></video><!-- used to hold the video stream from webcam -->
        </div><!-- .rounded-lg -->
        <p class="leading-relaxed text-terminal font-mono uppercase">Click "initialize" and allow access to your webcam.</p>
      ...
      <div class="sm:w-1/2 mb-10 px-4 max-w-sm mx-auto">
        <div class="rounded-lg h-64 my-4 border-2 border-terminal max-w-sm overflow-hidden">
          <img id="screenshot-img"/><!-- used to hold the static capture from video stream -->
          <canvas style="display:none;"></canvas>
        </div><!-- .rounded-lg -->
        <p class="leading-relaxed text-terminal font-mono uppercase">Click "take photo" to capture a still from your webcam.</p>
        <div>
						...
						<button id="save-button" class="cursor-pointer mx-auto mt-6 text-black font-mono uppercase border-0 py-2 px-5 border-2 border-terminal bg-terminal focus:outline-none hover:bg-transparent hover:border-white hover:text-white rounded capture-button opacity-20">Save photo</button>
					</div>
      </div><!-- .sm:w -->
  </div><!-- .flex-wrap -->
 </div><!-- .container -->
