...
<main class="flex-grow">
  ...
  <div class="container mx-auto w-full sm:w-1/2 lg:w-1/3 text-terminal text-3xl font-mono uppercase">
    <ul class="mx-4 sm:mx-0">
      <li><a href="" class="cursor-text text-terminal hover:text-opacity-50" title="the homepage">home</a></li>
      <li><a href="" class="cursor-text text-terminal hover:text-opacity-50" title="random notes and thoughts">weblog</a></li>
